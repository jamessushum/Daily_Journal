    ...
    radioButtons.forEach(
      ...
      button => {
        ...
        button.addEventListener('click', event => {
          ...
          // Access article HTML element where entry logs will be contained and removing all innerHTML before filtered mood entries can be displayed
          const logHtmlElement = document.querySelector(".entryLog")
          logHtmlElement.innerHTML = ""
